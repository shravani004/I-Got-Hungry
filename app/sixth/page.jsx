...
const page = () => {
  return (
    <div>
        ...
        <img class="w-full h-25 p-8 object-cover" src="https://images.immediate.co.uk/production/volatile/sites/2/2021/11/Croquembouche-profiterole-tower-ceb1da8.jpg?quality=90&resize=556,505" alt="Chocolate Tower" />
