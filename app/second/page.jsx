...
const page = () => {
  return (
    <div>
        ...
        <img class="w-full h-25 p-8 object-cover" src="https://hips.hearstapps.com/hmg-prod/images/07-antipasto-bites-12409-1589576492.jpg" alt="Artichoke Pesto Skewers" />
