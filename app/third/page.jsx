...
const page = () => {
  return (
    <div>
        ...
        <img class="w-full h-25 p-8 object-cover" src="https://hips.hearstapps.com/hmg-prod/images/steaksalad-1656608263.jpg?crop=0.820xw:0.547xh;0.0969xw,0.272xh&resize=640:*" alt="cheeseball bites" />
