    ...
    <div>
        <div>
            ...
            <div class="mt-8 grid lg:grid-cols-3 gap-10">
                <Link href="/starter" className="card hover:shadow-lg">    
                    <div>
                        <img src="https://www.archanaskitchen.com/images/archanaskitchen/basic_recipes/Amazing_Non_Veg_Appetizers__Starters_For_Your_New_Year_Party.jpg" alt="starters" class="w-full h-32 sm:h-48 object-cover" />
                        <div class="m-4">
                ...
                <Link href="/maincourse">
                    <div class="card hover:shadow-lg">
                        <img src="https://cdn.tasteatlas.com//images/toplistarticles/d0e6a0a79d5f4197a51f4ca065393ffe.jpg?w=375&h=280" alt="main course" class="w-full h-32 sm:h-48 object-cover" />
                        <div class="m-4">
                ...
                <Link href="/desserts">
                    <div class="card hover:shadow-lg">
                        <img src="https://www.foodandwine.com/thmb/ckc6L6xKox0WfpfO6dMkuVGPQOY=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Angel-Food-Cake-with-Three-Berry-Compote-FT-RECIPE0323-541a780b871441e0ab14383ee38acc44.jpg" alt="desserts" class="w-full h-32 sm:h-48 object-cover" />
                        <div class="m-4">
        ...
        <div id="pop">
            ...
            <div class="my-8 grid lg:grid-cols-3 gap-10">
                ...
                <Link href="/third">
                    <div class="card hover:shadow-lg">
                        <img src="https://hips.hearstapps.com/hmg-prod/images/steaksalad-1656608263.jpg?crop=0.820xw:0.547xh;0.0969xw,0.272xh&resize=640:*" alt="Steak, peach and watercress salad" class="w-full h-32 sm:h-48 object-cover" />
                        <div class="m-4">
                ...
                <Link href="/fourth">
                    <div class="card hover:shadow-lg">
                        <img src="https://i.ytimg.com/vi/_GaKxt84z7o/maxresdefault.jpg" alt="Lemon cheesecake" class="w-full h-32 sm:h-48 object-cover" />
                        <div class="m-4">
