...
const Cards = () => {
  ...
  return (
    <div>
        ...
        {/* <div id="icon" class="flex justify-center p-5">
            <button onClick={() => setShow(prev => !prev)}>
                <span class="btn bg-secondary-100 text-secondary-200 hover:shadow-inner transform hover:scale-105 hover:bg-opacity-50 transition ease-out duration-300">
                    Load more
                </span>
            </button>
        </div> */}
